...
Projet_binome/                                  # Dossier racine de votre projet Git
...
└── spring-petclinic/                           # Dossier contenant le code source de l'application Java
    ...
    │       ├── 01-bootstrap.yml                # Création automatisée ou manuelle du socle S3/DynamoDB
    │       ├── 02-infrastructure.yml           # Validation, scan tfsec et déploiement GitOps de l'IaC
    │       └── 03-application.yml              # Test Maven, scan Trivy, push Docker, mise à jour ECS et Smoke test
